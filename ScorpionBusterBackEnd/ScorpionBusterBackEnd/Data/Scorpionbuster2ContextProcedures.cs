...
namespace ScorpionBusterBackEnd.Data
{
    ...
    public partial class Scorpionbuster2ContextProcedures
    {
        ...
        public virtual async Task<List<GetConsommableResult>> GetConsommableAsync(OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<GetConsommableResult>("EXEC @returnValue = [dbo].[GetConsomable]", sqlParameters, cancellationToken);
