...
builder.Services.AddDbContext<ScorpionBusterBackEnd.Data.Scorpionbuster2Context>(
    options =>
    {
        options.UseSqlServer(builder.Configuration.GetConnectionString("ScorpionBuster2"));
    }
    );
